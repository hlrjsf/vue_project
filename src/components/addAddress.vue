    ...
    <div class="content_mian">
      <form action="./" method="post" name="address_add" id="address_add">
  			<div class="address_list">
  				<div class="user_name">
  					<span>收 件 人 ：</span>
            <input type="text" placeholder="收货人" v-model="userName" @focus="foucesBorder($event)" @blur="blurBorder($event)">
  				</div>
          <div class="user_phone">
            <span>手机号码 ：</span>
            <input type="text" placeholder="请输入手机号码" v-model="userPhone" @focus="foucesBorder($event)" @blur="blurBorder($event)">
          </div>
  				<div class="user_area" @click="choseAdd">
  					<span>所在地区 ：</span>
  					<input type="text" placeholder="省份/直辖市-城市-地区" v-model="userArea">
  				</div>
  				<div class="detail_address">
  					<span>详细地址 ：</span>
            <input type="text" placeholder="详细地址" v-model="detailAddress" @focus="foucesBorder($event)" @blur="blurBorder($event)">
  				</div>
  			</div>
      </form>
