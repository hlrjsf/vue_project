      ...
      <div id="scroller">
        ...
        <div class="content_mian">
          <div class="same_part_list">
            ...
            <div class="order_infs_list" @click="timeOfReceipt">
              <div class="time_of_receipt sp_title">收货时间</div>
              <div class="time_txt">
...
export default {
  ...
  methods: {
    ...
    timeOfReceipt: function() {
      //vue router配置的动态路由，页面无法自动刷新
      //this.$router.push({path: '/timeOfReceipt'});
      //刷新页面
      //this.$router.go(0);
    },
    payWays: function() {
